...
variable "app_image" {
  description = <<-EOT
    Full ECR image URI for the Django app.
    ...
    Example: 123456789.dkr.ecr.us-east-1.amazonaws.com/django-boilerplate/app:latest
  EOT
  type        = string
}
...
variable "worker_image" {
  description = <<-EOT
    ...
    Example: 123456789.dkr.ecr.us-east-1.amazonaws.com/django-boilerplate/worker:latest
  EOT
  type        = string
}
